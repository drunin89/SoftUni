...
namespace BookLibrary
{
    class BookLibrary
    {
        ...
        {
            var library = new Library() { Name = "SomeName", books = GetBooks() };
        ...
        public static List<Book> GetBooks()
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                var book = new Book() { Title = input[0], Author = input[1], Publisher = input[2], Date = date, ISBN = input[4], Price = double.Parse(input[5]) };
                books.Add(book);
            }
            return books;
        }
